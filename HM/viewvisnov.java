...
public class viewvisnov {
	...
	public static void mainNewScreen() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					viewvisnov window = new viewvisnov();
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 838, 524);
		...
		btnYes.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent g) {
				...
				try {
					...
					ResultSet rs = st.executeQuery("select * from addnovvis");
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					java.sql.Connection con = MydbConnectionClass.getConnection();
					String sql = "select * from addnovvis where studentname=?";
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					java.sql.Connection con = MydbConnectionClass.getConnection();
					String sql = "select * from addnovvis where entrytime=?";
					java.sql.PreparedStatement pdt = con.prepareStatement(sql);
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					java.sql.Connection con = MydbConnectionClass.getConnection();
					String sql = "select * from addnovvis where leavingtime=?";
					java.sql.PreparedStatement pdt = con.prepareStatement(sql);
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					java.sql.Connection con = MydbConnectionClass.getConnection();
					String sql = "select * from addnovvis where day=?";
					java.sql.PreparedStatement pdt = con.prepareStatement(sql);
		...
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					java.sql.Connection con = MydbConnectionClass.getConnection();
					String sql = "select * from addnovvis where year=?";
					java.sql.PreparedStatement pdt = con.prepareStatement(sql);
