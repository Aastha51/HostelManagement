...
public class viewvisfeb {
	...
	public static void mainNewScreen() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					viewvisfeb window = new viewvisfeb();
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 819, 506);
		...
		btnYes.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent g) {
				...
				try {
					...
					ResultSet rs = st.executeQuery("select * from addfebvis");
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					java.sql.Connection con = MydbConnectionClass.getConnection();
					String sql = "select * from addfebvis where studentname=?";
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					java.sql.Connection con = MydbConnectionClass.getConnection();
					String sql = "select * from addfebvis where entrytime=?";
					java.sql.PreparedStatement pdt = con.prepareStatement(sql);
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					java.sql.Connection con = MydbConnectionClass.getConnection();
					String sql = "select * from addfebvis where leavingtime=?";
					java.sql.PreparedStatement pdt = con.prepareStatement(sql);
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					java.sql.Connection con = MydbConnectionClass.getConnection();
					String sql = "select * from addfebvis where day=?";
					java.sql.PreparedStatement pdt = con.prepareStatement(sql);
		...
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					java.sql.Connection con = MydbConnectionClass.getConnection();
					String sql = "select * from addfebvis where year=?";
					java.sql.PreparedStatement pdt = con.prepareStatement(sql);
